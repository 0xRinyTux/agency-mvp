    ...
    <section className="relative bg-slate-50 text-slate-900 py-16 lg:py-24 overflow-hidden">
      <div className="container mx-auto px-6 max-w-7xl relative z-10">
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
          <div className="flex flex-col items-start">
            ...
            <div className="flex flex-col sm:flex-row gap-4 w-full sm:w-auto">
              <a 
                ...
                style={{ backgroundColor: data.meta.primary_color, boxShadow: `0 10px 20px -5px ${data.meta.primary_color}60` }}
              >
          ...
          <div className="relative w-full aspect-square md:aspect-video lg:aspect-square max-h-[500px] rounded-[2rem] overflow-hidden shadow-2xl border-4 border-white">
            <Image 
