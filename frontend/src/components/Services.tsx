      ...
      <div className="container mx-auto px-6 max-w-7xl">
        <div className="text-center mb-16">
          <h2 className="text-3xl md:text-4xl font-extrabold text-slate-900 mb-4 tracking-tight">
            {data.services?.title || "I Nostri Servizi"}
          </h2>
        ...
        <div className="mt-20 bg-slate-900 text-white rounded-[2rem] p-10 md:p-14 shadow-2xl grid md:grid-cols-2 gap-10 items-center">
          <div>
            <h2 className="text-3xl font-extrabold mb-6 leading-tight">
              {data.about?.title || "Informazioni su di noi"}
            </h2>
          ...
          <div className="flex justify-center md:justify-end">
             {data.contact?.phone && (
               <a 
                  ...
                  style={{ backgroundColor: data.meta?.primary_color || '#e11d48', boxShadow: `0 10px 25px -5px ${data.meta?.primary_color || '#e11d48'}80` }}
                >
                  <svg className="w-6 h-6 mr-2" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                    <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2.5} d="M3 5a2 2 0 012-2h3.28a1 1 0 01.948.684l1.498 4.493a1 1 0 01-.502 1.21l-2.257 1.13a11.042 11.042 0 005.516 5.516l1.13-2.257a1 1 0 011.21-.502l4.493 1.498a1 1 0 01.684.949V19a2 2 0 01-2 2h-1C9.716 21 3 14.284 3 6V5z" />
                  </svg>
                  {data.about?.cta || "Chiama Ora"}
                </a>
             )}
          </div>
        </div>
